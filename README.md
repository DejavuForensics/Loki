...
Table 1 shows the results of the evaluated 89 antivirus products. Two of these antiviruses scored above 99%. These antiviruses were: MicroWorld-eScan, BitDefender, ESET-NOD32, Panda, Ad-Aware,	NANO-Antivirus,	K7AntiVirus, K7GW, Fortinet, and GData. Malware detection indicates that these antivirus programs provide a robust service against cyber-intrusions.
